...
class FileUpDownRequest(OSSBaseModel):
    ...
    object_key: str = Field(..., description="Name/path of the file to upload (supports subdirectories like user_id/date/file.jpg)")
    ...
    def validate_object_key(cls, v):
        ...
        for seg in segments:
            ...
            if len(safe_seg) > 255:
                raise ValueError("object_key segment too long")
        ...
        if len(safe_object_key) > 1024:
            raise ValueError("object_key path too long")
