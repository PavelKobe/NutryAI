...
export default function FoodScanDemoSection() {
          ...
          >
            ...
            >
              ...
              <div className="flex-1">
                <div className="text-white font-bold text-lg mb-1" style={{ fontFamily: "var(--font-space-grotesk), sans-serif" }}>
                  Дневник питания
                </div>
                ...
                >
                  {[
                    ...
                    <div key={m.label}>
                      ...
                      <div className="font-bold text-sm" style={{ color: m.color, fontFamily: "var(--font-space-grotesk), sans-serif" }}>
                        {m.val}
            ...
            >
              ...
              <a
                href="/register"
                className="px-4 py-2 rounded-xl text-black text-xs font-bold whitespace-nowrap cursor-pointer transition-transform duration-200 hover:scale-105 flex-shrink-0"
