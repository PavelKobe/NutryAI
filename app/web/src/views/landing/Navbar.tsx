    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2.5 cursor-pointer group">
          ...
          <div className="flex items-baseline gap-1" style={{ fontFamily: "var(--font-space-grotesk), sans-serif" }}>
        ...
        <div className="hidden md:flex items-center gap-3">
          <Link
            href="/register"
            className="px-5 py-2 rounded-full text-sm font-medium bg-emerald-500 hover:bg-emerald-400 text-black transition-all duration-200 whitespace-nowrap cursor-pointer"
      ...
      >
        <div className="px-6 py-4 flex flex-col gap-4 border-t border-white/10">
          ...
          <Link
            href="/register"
            className="px-5 py-2.5 rounded-full text-sm font-medium bg-emerald-500 text-black text-center whitespace-nowrap cursor-pointer"
          >
            Начать бесплатно
          </Link>
        </div>
