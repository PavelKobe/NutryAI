      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-stretch justify-center">
          ...
          >
            ...
            <div className="mb-8">
              <div className="flex items-end gap-2">
                <span className="text-6xl font-black text-white" style={{ fontFamily: "var(--font-space-grotesk), sans-serif" }}>
                  0 ₽
                </span>
              </div>
            ...
            <a
              href="/register"
              className="block text-center py-3.5 rounded-xl text-sm font-semibold mb-8 cursor-pointer whitespace-nowrap transition-all duration-200 hover:scale-105"
              style={{
          ...
          >
            ...
            <a
              href="/register"
              className="relative block text-center py-3.5 rounded-xl text-sm font-bold mb-8 cursor-pointer whitespace-nowrap overflow-hidden group transition-all duration-200 hover:scale-105"
              style={{
                background: 'linear-gradient(135deg, #00e676, #1de9b6)',
                color: '#000000',
                textDecoration: 'none',
