...
type CTASectionProps = { onAuthStart: () => void | Promise<void> };

export default function CTASection({ onAuthStart }: CTASectionProps) {
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          <button
            ...
            className="group px-10 py-4 rounded-full text-black font-bold text-lg cursor-pointer whitespace-nowrap transition-all duration-300 hover:scale-105 border-0"
            style={{
