...
const words = ['питание', 'здоровье', 'энергию', 'баланс'];

type HeroSectionProps = { onAuthStart: () => void | Promise<void> };

export default function HeroSection({ onAuthStart }: HeroSectionProps) {
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6 text-center">
        ...
        >
          <button
            ...
            className="group relative px-8 py-4 rounded-full text-black font-bold text-lg overflow-hidden cursor-pointer whitespace-nowrap transition-transform duration-200 hover:scale-105 border-0"
            style={{
