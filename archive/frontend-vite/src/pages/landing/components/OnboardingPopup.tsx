        ...
        {[
          ...
          >
            <span
              ...
              style={{ color: '#00e676', fontFamily: "'Space Grotesk', sans-serif" }}
            >
              {val}
            </span>
...
type OnboardingPopupProps = { onAuthStart: () => void | Promise<void> };

export default function OnboardingPopup({ onAuthStart }: OnboardingPopupProps) {
