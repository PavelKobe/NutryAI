...
const CATEGORIES: FAQCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: 'Есть ли отслеживание воды и активности?',
        a: 'Да, в приложении есть трекер воды с напоминаниями, учёт физической активности и синхронизация с Apple Health / Google Fit. Все данные учитываются при расчёте суточной нормы калорий.',
      },
      {
        q: 'Какая аналитика доступна?',
        a: 'Вы видите графики калорий и макросов за день, неделю и месяц, динамику веса, дефицит/профицит калорий, микронутриентный анализ (витамины, минералы) и сравнение с нормами ВОЗ. Premium-пользователи получают расширенные AI-отчёты.',
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        q: 'Чем Premium отличается от Free?',
        a: 'Premium снимает все ограничения: безлимитное сканирование, неограниченный чат с ИИ-нутрициологом, генерация планов питания и рецептов, расширенная аналитика с AI-отчётами, приоритетная поддержка и ранний доступ к новым функциям.',
      },
      {
        q: 'Можно ли отменить подписку в любой момент?',
        a: 'Да, подписку можно отменить в любое время без штрафов и объяснений. После отмены доступ к Premium сохраняется до конца оплаченного периода. Возврат средств возможен в течение 7 дней после оплаты.',
      },
      {
    ...
    >
      ...
      >
        ...
        <span
          ...
          style={{ color: isOpen ? '#ffffff' : '#bbb', fontFamily: "'Space Grotesk', sans-serif" }}
        >
          {item.q}
        </span>
